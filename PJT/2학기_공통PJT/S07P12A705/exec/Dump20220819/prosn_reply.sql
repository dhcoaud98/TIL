...
CREATE TABLE `reply` (
  ...
  `commnet_id` bigint DEFAULT NULL,
  `user_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKasq02h9b7qs3c2mru4t295qcc` (`commnet_id`),
  KEY `FKmtfnx1efxiq3p9n6kh3org2yj` (`user_id`),
  CONSTRAINT `FKasq02h9b7qs3c2mru4t295qcc` FOREIGN KEY (`commnet_id`) REFERENCES `comment` (`id`),
